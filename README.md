...
Mmebuat query skyline menggunakan map dengan 1000 data
Dengan kode
```
#include <iostream>
#include <fstream>
...
```
Dengan menggunakan map waktu yang dibutuhkan adalah 17398451 nanodetik atau setara dengan 0.0174 detik.
